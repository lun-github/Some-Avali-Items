...
public class AeropickhandleItem extends Item {
	public AeropickhandleItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.some_avali_item.aeropickhandle.description_0"));
	}
}