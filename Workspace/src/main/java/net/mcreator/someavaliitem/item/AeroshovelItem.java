...
import net.mcreator.someavaliitem.procedures.Aeroshovel_block_destroyedProcedure;
import net.mcreator.someavaliitem.init.SomeAvaliItemModItems;

import java.util.List;

public class AeroshovelItem extends ShovelItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		Aeroshovel_block_destroyedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity, itemstack);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.some_avali_item.aeroshovel.description_0"));
		list.add(Component.translatable("item.some_avali_item.aeroshovel.description_1"));
		list.add(Component.translatable("item.some_avali_item.aeroshovel.description_2"));
		list.add(Component.translatable("item.some_avali_item.aeroshovel.description_3"));
