...
import net.mcreator.someavaliitem.procedures.Portable_printer_rbmProcedure;
import net.mcreator.someavaliitem.procedures.Portable_printer_hand_tickProcedure;

import java.util.List;

public class PortableprinterItem extends Item {
	public PortableprinterItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		Portable_printer_rbmProcedure.execute(world, entity, ar.getObject());
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			Portable_printer_hand_tickProcedure.execute(entity);
	}
}