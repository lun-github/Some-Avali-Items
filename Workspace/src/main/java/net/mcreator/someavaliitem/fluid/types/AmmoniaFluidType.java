package net.mcreator.someavaliitem.fluid.types;
...
public class AmmoniaFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("some_avali_item:block/ammonia_liq");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("some_avali_item:block/ammonia_liq");
		...
		}, SomeAvaliItemModFluidTypes.AMMONIA_TYPE.get());
	}
}